...
\
\ The SM1 has some instructions that are combined versions
...
\ status register
: ST_SNDTN h# 0001 ; \ send
: ST_RCVTN h# 0002 ; \ receive
: ST_RCVQT h# 0004 ; \ receive quantity
: ST_IRQ   h# 0008 ; \ interrupt
: ST_IMK   h# 0010 ; \ interrupt mask

: stsndtn?  getst      ST_SNDTN and ;
: strcvtn?  getst      ST_RCVTN and ;
: strcvqt?  getst      ST_RCVQT and ;
: stirq?    getst      ST_IRQ   and ;
: stimk?    getst      ST_IMK   and ;
